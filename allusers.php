...
$dbname = "family";
	...
	$image_query = mysqli_query($result,"select username ,dateofb, email, fullname, numberofch, gender, interests, file_name from logininfo ");
	while($rows = mysqli_fetch_array($image_query))
	{
		$interests = $rows['interests'];
		$profilepic = $rows['file_name'];
        $email = $rows['email'];
...
-->
  ...
  <div class="infobox">
    ...
    <div class="">
      <p class="align-left">Username:</p><p class="align-right"><?php echo $username; ?></p>  
    </div>
    
    <div class="clear-float">
      <p class="align-left">Interest:</p><p class="align-right"><?php echo $interests; ?></p>  
    </div>
      
    <div class="clear-float">
      <p class="align-left">Gender:</p><p class="align-right"><?php echo $gender; ?></p>  
    </div>
    <div class="clear-float">
      <p class="align-left">Email:</p><p class="align-right"><?php echo $email; ?></p>  
    </div>
    <div class="clear-float">
      <p class="align-left">No. of Children:</p><p class="align-right"><?php echo $children; ?> </p>  
    <div class="clear-float">
      <p class="align-left">Birthday:</p><p class="align-right"><?php echo $dateofb; ?></p>
      </div>
